...
Ext.onReady(function() {
	...
	var tbar = Co.toolbar("tbar", [{
			...
			searchField : [${code.searchFields}],
			searchEmptyText : [${code.searchEmptyTexts}]
		}
	]);
	...
	var ${code.classNameLowerPrefix}Grid = Co.grid("${code.classNameLowerPrefix}Grid", ${code.classNameLowerPrefix}GridStore, columns, tbar, null, {
		listeners : {
